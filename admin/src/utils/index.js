export { createArrayFromTo, makeUnique, moveArray } from "./arrayMethods";
export { getObjectKeys, getObjectLength, getObjectValues } from "./getObjectProp";
...
export { replaceAll } from "./stringMethods";
